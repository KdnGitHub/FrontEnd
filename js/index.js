...
function showTime(){
    ...
    var content = `${month}-${day}-${year} ${hour}:${minute}:${second}`;
...
getData();
setInterval(getData,30*60*1000); // 每30分钟自动获取数据
...
function left1(data){
    ...
    for(var day of chinaDayList){
        ...
        option.series[3].data.push(day.dead);
    }
